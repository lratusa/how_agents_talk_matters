...
\author{[Author Names]\textsuperscript{1,}\thanks{\textsuperscript{1}[Department, Institution, City, Country]. Corresponding author: \texttt{[email@example.com]}. ORCID: \texttt{[0000-0000-0000-0000]}.}}
\date{September 2026}

\begin{document}
\maketitle
\pagestyle{myheadings}
\markright{[Author Names]: Who Should Review Whom?}
